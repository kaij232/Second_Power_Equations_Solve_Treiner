...
public class mainVietaWindow {
	...
	public static JFrame vw = new JFrame("Решение квадратных уравнений через теорему Виета");
...
//	Schot
//	constr.insets = null;
//	constr.insets = new Insets(0,100,0,150);
...
constr.insets = new Insets(0,0,0,0);
	...
	vw.setBounds(300, 100, 700, 500);
	vw.getContentPane().setBackground(new Color(0, 250, 154));
	vw.add(container);
}
